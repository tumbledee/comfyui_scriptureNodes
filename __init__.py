...
from .sampling.enchant_scrolls              import NODE_CLASS_MAPPINGS as C1, NODE_DISPLAY_NAME_MAPPINGS as C12
from .sampling.dechant_scrolls              import NODE_CLASS_MAPPINGS as C2, NODE_DISPLAY_NAME_MAPPINGS as C22
...
NODE_CLASS_MAPPINGS        = {**ckptSL, **C1, **C2, **A, **AA, **B, **C, **D, **E, **F, **G}
NODE_DISPLAY_NAME_MAPPINGS = {**ckptSL2, **C12, **C22, **A2, **AA2, **B2, **C2, **D2, **E2, **F2, **G2}
