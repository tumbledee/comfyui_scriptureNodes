...
class ExampleUnpackNode:
    @classmethod
    def INPUT_TYPES(cls):
        return {"required": {"pipe": ("PIPE_LINE",)}}

    RETURN_TYPES = ("MODEL", "CONDITIONING", "CONDITIONING", "INT", "INT")
    RETURN_NAMES = ("model", "positive", "negative", "width", "height")
    FUNCTION = "unpack"
    CATEGORY = "utils/pipeline"

    def unpack(self, pipe):
        return (pipe["model"], pipe["positive_cond"], pipe["negative_cond"], pipe["width"], pipe["height"])
